...
{
    //removing inline commenting for now 
    //_inLineCommentView.hidden = NO;
    //[_inLineCommentTextField becomeFirstResponder];
}

- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    [textField resignFirstResponder];
    _inLineCommentView.hidden = YES;
...
-(BOOL)launchInSignupMode
{
    ...
    {
        [appDelegate launchInSignupMode:parent];
        return YES;
    }
    return NO;
}
...
-(IBAction)shareToTwitter:(id)sender
{
    if([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter])
    {
        ...
        [tweetController addImage:[UIImage imageNamed:self.factData.picFilePath]];
...
-(IBAction)shareToFacebook:(id)sender
{
    if([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook])
    {
        ...
        [facebookController addImage:[UIImage imageNamed:self.factData.picFilePath]];
